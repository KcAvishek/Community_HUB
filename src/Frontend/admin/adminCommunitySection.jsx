...
//                 <th className="table-head">Leader ID</th>
//                 <th className="table-head">Leader Username</th>
...
//                 <tr>
//                   <td colSpan="5" className="table-empty">No communities found</td>
//                 </tr>
//               ) : (
//                 communities.map((community) => {
//                   const leader = allUsers.find((user) => user._id === community.leader_id);
//                   return (
...
//                       <td className="table-cell">{leader ? leader.username : 'N/A'}</td>
            ...
            >
              ...
              {allUsers
                .filter((user) =>
                  !communities.some(
                    (community) =>
                      community.leader_id === user._id &&
                      community._id !== (selectedCommunityForUpdate?._id || '')
                  )
                )
                .map((user) => (
