...
// 
//     const events = await Event.find({ created_by: userId }).populate('created_by');
// 
//     return res.status(200).json({
...
//   } catch (err) {
//     console.error(err);
//     return res.status(500).json({ message: "Error fetching user events", error: err.message });
//   }
// };
// 
// 
// module.exports = { createEvent, getAllEvents, getEventById, updateEvent, deleteEvent, getEventsByUser };
